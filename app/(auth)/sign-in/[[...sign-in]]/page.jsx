        ...
        <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                <div className="relative z-10 w-full max-w-md">
                    <img src="https://static.vecteezy.com/system/resources/previews/055/742/539/non_2x/a-colorful-brain-on-a-transparent-background-free-png.png" width={150} />
                    <div className=" mt-16 space-y-3">
                        <h3 className="text-white text-3xl font-bold">Welcome to AI Interview Site</h3>
                        <p className="text-gray-300">
                            Sign in into your account and get started on cracking your dream job with AI Interview Site.
                        </p>
...
// to modify the sign-in page, you can google `Clerk elements`